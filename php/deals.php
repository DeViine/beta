<?php
$directory = 'deals/';	//where the text files are located

$allowed_types=array('txt', 'rtf');	//allowed file types
...
$dir_handle = @opendir($directory) or die("There is an error with your content directory!");
