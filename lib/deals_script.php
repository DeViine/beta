...
//This script checks to see if the deal# folder exists in the ../lib/deals directory, if it does then the deal is posted, but if it doesn't then it is not posted.
